...
ind=1190:2944; %para los datos de fondo
...
a=load([pathn1 'minidot_fondo_1512025_2612025.dat']);
fech1=datenum(a(:,1:6))-3/24;
Do1=a(:,9);
...
print -dtiff -r300 serie_fondo

eval(['save ' pathn 'anclaje_fondo fech fech1 sali Do1 prof temp ind']) 
